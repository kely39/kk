...
CREATE TABLE `exam_chapter`  (
  ...
  `car_type` tinyint(2) NOT NULL COMMENT '车型(2-客车 3-货车 4-客运 5-货运 6-危险品 7-教练员)',
  `subject` tinyint(2) NOT NULL COMMENT '所属科目（字典：1. 科一，2. 科二，3. 科三，4. 科三理论，0.资格证）',
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `total` int(4) NULL DEFAULT 0 COMMENT '该章节下的习题数量汇总',
  `num` int(4) NULL DEFAULT 0 COMMENT '排序值',
  `locality` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否地方性(0-否|1-是)',
  `delete_flag` bit(1) NOT NULL DEFAULT b'0' COMMENT '逻辑删除标识（0.未删除 1.已删除）',
  `created_user_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人id',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `updated_user_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人id',
  `last_updated_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '章节' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of exam_chapter
-- ----------------------------
INSERT INTO `exam_chapter` VALUES ('1', 2, 1, '道路交通安全法律、法规和规章', 99, 1, b'0', b'0', NULL, NULL, NULL, NULL);
INSERT INTO `exam_chapter` VALUES ('10', 2, 4, '驾驶职业道德和文明驾驶常识', 171, 4, b'0', b'0', NULL, NULL, NULL, NULL);
INSERT INTO `exam_chapter` VALUES ('11', 2, 4, '恶劣气候和复杂道路条件下驾驶常识', 225, 5, b'0', b'0', NULL, NULL, NULL, NULL);

-- ----------------------------
-- Table structure for kk_sms
-- ----------------------------
DROP TABLE IF EXISTS `kk_sms`;
CREATE TABLE `kk_sms`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `mobile` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '手机号',
  `sms_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '短信验证码',
  `template_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模板id',
  `content` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '短信内容',
  `status` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否发送 0否    1是',
  `use_flag` bit(1) NULL DEFAULT b'0' COMMENT '是否使用',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '短信表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of kk_sms
-- ----------------------------
INSERT INTO `kk_sms` VALUES ('2019123128203cb4f64140e6981bf33031dd3e74', '17512036360', '096713', 'templateCode', '未知templateCode', b'0', b'0', '2019-12-31 15:41:11', NULL, '返回reponse=null');
INSERT INTO `kk_sms` VALUES ('2019123139595d823d8f4fb69d39e2241c7a4388', '17512036361', '708786', 'templateCode', '未知templateCode', b'0', b'0', '2019-12-31 15:45:11', NULL, '返回reponse=null');
INSERT INTO `kk_sms` VALUES ('20191231f1e9f15097bb45d38992ec1c111f7d6f', '17512036361', '198256', 'templateCode', '未知templateCode', b'0', b'0', '2019-12-31 11:19:02', NULL, '返回reponse=null');
...
CREATE TABLE `kk_user`  (
  ...
  `user_num` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户编号',
  ...
  `freeze_flag` bit(1) NULL DEFAULT b'0' COMMENT '是否冻结',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `last_updated_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `delete_flag` bit(1) NOT NULL DEFAULT b'0' COMMENT '逻辑删除标识（0.未删除 1.已删除）',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of kk_user
-- ----------------------------
INSERT INTO `kk_user` VALUES ('201912311964d61220254b5c859a5c5a329cbcf1', '17512036361', '$2a$10$csa1buZ33GEbrTe24OpSiejdG0Qjm.eyEm61W17fvqYej8v0wphli', '20191231eb9265a2', '$2a$10$csa1buZ33GEbrTe24OpSie', 'http://thirdwx.qlogo.cn/mmopen/CxCEX0QG0d9LRpFRmgY5OxcYmHicZWzLpbyMROmutcFk0jicef83fMLGSgUAicLYD5u6V03F7vQR3u9lF5819dlKGLBrFM6tpdE/132', '无K', '17512036361', 1, b'0', '2019-12-31 11:21:59', '2019-12-31 15:46:59', b'0');

-- ----------------------------
-- Table structure for kk_user_weixin_info
-- ----------------------------
DROP TABLE IF EXISTS `kk_user_weixin_info`;
CREATE TABLE `kk_user_weixin_info`  (
...
-- ----------------------------
-- Records of kk_user_weixin_info
-- ----------------------------
INSERT INTO `kk_user_weixin_info` VALUES ('20191231b9a03630a41a43db869c878a353a7fbd', '201912311964d61220254b5c859a5c5a329cbcf1', NULL, 'wx4204fdfb01794b59', 'oxpbmsurlSNHmusK2btXaX5r_gqo', NULL, '{\"city\":\"\",\"country\":\"乌拉圭\",\"groupId\":0,\"headImgUrl\":\"http://thirdwx.qlogo.cn/mmopen/CxCEX0QG0d9LRpFRmgY5OxcYmHicZWzLpbyMROmutcFk0jicef83fMLGSgUAicLYD5u6V03F7vQR3u9lF5819dlKGLBrFM6tpdE/132\",\"language\":\"zh_CN\",\"nickname\":\"无K\",\"openId\":\"oxpbmsurlSNHmusK2btXaX5r_gqo\",\"province\":\"\",\"qrScene\":\"0\",\"qrSceneStr\":\"\",\"remark\":\"\",\"sex\":1,\"sexDesc\":\"男\",\"subscribe\":true,\"subscribeScene\":\"ADD_SCENE_QR_CODE\",\"subscribeTime\":1575959645,\"tagIds\":[]}', '2019-12-31 11:16:27', '2019-12-31 11:21:59', b'0');
